...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const handleTabClick = (event) => {
        ...
        tabGroup.querySelectorAll('a').forEach(tab => tab.classList.remove('active'));

        // Sembunyikan semua konten yang terkait dengan grup ini
        ...
        if (tabGroup.matches('.time-nav-tabs')) {
            ...
            if (clickedTab.getAttribute('data-view') === 'total') {
                ...
                const periodDisplayText = document.getElementById('period-display-text');
